...
SWEP.ShootSound2 = Sound("MVM.GiantHeavyGunFire")
SWEP.SpecialSound1 = Sound("MVM.GiantHeavyGunWindUp")
SWEP.SpecialSound2 = Sound("MVM.GiantHeavyGunWindDown")
SWEP.SpecialSound3 = Sound("MVM.GiantHeavyGunSpin")
SWEP.ShootCritSound = Sound("MVM.GiantHeavyGunFire")
