...
SWEP.ViewModel = Model( "models/v_models/v_shotgun_chrome.mdl" )
...
SWEP.ReloadTime = 0.5
SWEP.HitDistance = 48
SWEP.ShootSound = Sound(")weapons/shotgun_chrome/gunfire/shotgun_fire_1.wav")
