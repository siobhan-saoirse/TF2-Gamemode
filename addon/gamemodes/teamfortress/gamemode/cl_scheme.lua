...
Colors = {
	...
	QualityColorStrange=Color(207, 106, 50,255),
	QualityColorHaunted=Color(56, 243, 171,255),
	QualityColorCollectors=Color(170, 0, 0,255),
	QualityColorCompleted=Color(134,80,172,255),
