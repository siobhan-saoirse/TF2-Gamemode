...
if CLIENT then
	...
	CLASS.ScoreboardImage = {
		surface.GetTextureID("vgui/s_panel_teenangst"),
		surface.GetTextureID("vgui/s_panel_teenangst")
	}
end
...
if SERVER then
	...
	function CLASS:Initialize()
		self:SetModel("models/l4d/survivor_teenangst.mdl")
		self:Give("weapon_l4d2_baseball_bat")
		self:Give("weapon_smg_silenced")
		self:Give("weapon_l4d2_pistol")
		self:Give("weapon_l4d2_first_aid_kit")
		
		self:SelectWeapon("weapon_l4d2_smg_silenced")
	end
