...
concommand.Add("open_taunt_menu", function()

	local pnl = vgui.Create("DFrame")
	pnl:SetSize(960, 700)
	pnl:Center()
	pnl:SetTitle("TF2 Taunt Menu")
	pnl:MakePopup()
	
	pnl:SetDraggable(true) --can you move it around
	pnl:SetSizable(false) --can you resize it?
	pnl:ShowCloseButton(true)

	local DImageButton = vgui.Create( "DImageButton", pnl )
	...
	Hint:SizeToContents()
	local Hint2 = vgui.Create( "DLabel", pnl )
	Hint2:SetPos( 0, 625 )
