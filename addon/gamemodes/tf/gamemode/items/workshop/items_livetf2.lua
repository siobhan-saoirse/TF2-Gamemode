	...
	"items"
	{
		...
		"234"
		{
			...
			"tool"
			{
				...
				"usage"
				{
					// give out up to 23 gifts (we want to encourage servers of 24 people and player giving gift will not get a gift from themselves)
		...
		"2002"
		{
			...
			{
				"Black Box"				"1"
				"Battalion's Backup"	"1"
				"Grenadier's Softcap"	"1"
			}
			"item_type_name"	"#TF_StoreBundle"
