...
SWEP.ShootSound = Sound("Weapon_Degreaser.FireStart")	
SWEP.SpecialSound1 = Sound("Weapon_Degreaser.FireLoop")
SWEP.ShootCritSound = Sound("Weapon_Degreaser.FireLoopCrit")
SWEP.ShootSoundEnd = Sound("Weapon_Degreaser.FireEnd")
