...
if SERVER then
	...
	function CLASS:Initialize()
		self:SetModel(table.Random({"models/infected/boomer.mdl","models/infected/boomer.mdl","models/infected/boomer.mdl","models/infected/boomer.mdl","models/infected/boomer_l4d1.mdl","models/infected/boomette.mdl"}))
