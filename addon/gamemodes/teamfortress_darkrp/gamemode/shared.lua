...
sound.Add( {
	...
	pitch = { 100 },
	channel = CHAN_WEAPON,
	sound = { "player/pl_fallpain.wav","player/damage1.wav","player/damage2.wav" } 
} )
sound.Add( {
	name = "Player.FallGib",
	volume = 1.0,
...
hook.Add("Think", "PlayerStuff", function()	
	for k,pl in ipairs(player.GetAll()) do
		...
		if (pl:IsBot() && pl.IsL4DZombie) then
			pl:RemoveFlags(FL_CLIENT)
			pl:AddFlags(FL_NPC)
		end
	end
end)
...
GM.Name 		= "Team Fortress 2 DarkRP"
...
TEAM_FRIENDLY = 5
TEAM_INFECTED = 6
TF_TEAM_PVE_INVADERS = 7
TF_TEAM_PVE_INVADERS_GIANT = 7
...
function GM:CreateTeams()
	...
	team.SetUp(TEAM_INFECTED, "Infected", Color(255, 0, 0))
	SetTeamSecondaryColor(TEAM_INFECTED, Color(255, 0, 0))
	team.SetSpawnPoint(TEAM_INFECTED, "worldspawn")
	...
	team.SetUp(TF_TEAM_PVE_INVADERS, "ROBOTS", Color(153, 204, 255))
	SetTeamSecondaryColor(TF_TEAM_PVE_INVADERS, Color(104, 124, 155))
	team.SetSpawnPoint(TF_TEAM_PVE_INVADERS, "worldspawn")
end
