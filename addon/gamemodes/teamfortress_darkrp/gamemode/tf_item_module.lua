...
function ITEM:ItemIndex()
	if (!isnumber(self.dt.itemid)) then
			...
			if self:IsWeapon() and self.SetupCModelActivities then
				if item.attach_to_hands==1 then
					...
					if t and t.ModelName then
						if (self.Owner:GetPlayerClass() != "civilian_" && self.Owner:GetPlayerClass() != "tank" && self.Owner:GetPlayerClass() != "hunter" && self.Owner:GetPlayerClass() != "smoker" && self.Owner:GetPlayerClass() != "spitter" && self.Owner:GetPlayerClass() != "jockey" && self.Owner:GetPlayerClass() != "boomer" && self.Owner:GetPlayerClass() != "boomette" && self.Owner:GetPlayerClass() != "charger" && self.Owner:GetPlayerClass() != "witch" ) then
