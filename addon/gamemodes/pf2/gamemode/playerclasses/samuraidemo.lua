...
if CLIENT then
	...
	CLASS.ScoreboardImage = {
		surface.GetTextureID("hud/leaderboard_class_demoknight_samurai"),
		surface.GetTextureID("hud/leaderboard_class_demoknight_samurai")
	}
end

CLASS.Loadout = {}
CLASS.DefaultLoadout = {"Splendid Screen","Half-Zatoichi","Samur-Eye"}
...
if SERVER then
	...
	function CLASS:Initialize()
		...
		timer.Simple(0.2, function()
			...
			self:SetJumpPower(self.PlayerJumpPower * 2.3)
