...
local bleed_drop = surface.GetTextureID("hud/condition_icons/ico_infected")
local slowed = surface.GetTextureID("vgui/slowed")
local sleepy = surface.GetTextureID("hud/condition_icons/ico_sleepy")
