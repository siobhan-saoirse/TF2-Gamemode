...
if SERVER then
	hook.Add("PlayerHandleAnimEvent","TFPlayerFootsteps",function( ply, event, eventTime, cycle, type, options )
		if (event == 7001) then
			ply:PlayStepSound(1)
		end
	end)
...
function GM:UpdateAnimation(pl, velocity, maxseqgroundspeed)		
	...
	if (pl:IsHL2()) then		  
		pl:SetViewOffset(Vector(0,0,62 * pl:GetModelScale()))
		pl:SetViewOffsetDucked(Vector(0, 0, 28 * pl:GetModelScale()))
	else
		pl:SetViewOffset(Vector(0, 0, 72 * pl:GetModelScale()))
...
hook.Add("TranslateActivity", "TF2PMStuff", function(pl, act) 
	...
	if (IsValid(pl:GetActiveWeapon()) and pl:GetActiveWeapon():GetClass() == "weapon_annabelle" and pl:IsHL2()) then
		ActivityTranslateFixTF2[ACT_MP_STAND_IDLE] 						= ACT_HL2MP_IDLE_SHOTGUN
		ActivityTranslateFixTF2[ACT_MP_RUN] 							= ACT_HL2MP_IDLE_SHOTGUN + 2
		ActivityTranslateFixTF2[ACT_MP_WALK] 							= ACT_HL2MP_IDLE_SHOTGUN + 1
		ActivityTranslateFixTF2[ACT_MP_CROUCHWALK] 							= ACT_HL2MP_IDLE_SHOTGUN + 4
		ActivityTranslateFixTF2[ACT_MP_CROUCH_IDLE] 							= ACT_HL2MP_IDLE_SHOTGUN + 3

		ActivityTranslateFixTF2[ACT_MP_ATTACK_STAND_PRIMARYFIRE] 						= ACT_HL2MP_IDLE_SHOTGUN + 5
		ActivityTranslateFixTF2[ACT_MP_ATTACK_CROUCH_PRIMARYFIRE] 						= ACT_HL2MP_IDLE_SHOTGUN + 5
		ActivityTranslateFixTF2[ACT_MP_RELOAD_STAND] 						= ACT_HL2MP_IDLE_SHOTGUN + 6
		ActivityTranslateFixTF2[ACT_MP_RELOAD_CROUCH] 						= ACT_HL2MP_IDLE_SHOTGUN + 6
		ActivityTranslateFixTF2[ACT_MP_JUMP] 						= ACT_HL2MP_IDLE_SHOTGUN + 7
		ActivityTranslateFixTF2[ACT_MP_SWIM_IDLE] 						= ACT_HL2MP_IDLE_SHOTGUN + 8
		ActivityTranslateFixTF2[ACT_MP_SWIM] 						= ACT_HL2MP_IDLE_SHOTGUN + 9
		return ActivityTranslateFixTF2[act] or act
	elseif (IsValid(pl:GetActiveWeapon()) and pl:GetActiveWeapon():GetClass() == "weapon_alyxgun" and pl:IsHL2()) then
		ActivityTranslateFixTF2[ACT_MP_STAND_IDLE] 						= ACT_HL2MP_IDLE_PISTOL
		ActivityTranslateFixTF2[ACT_MP_RUN] 							= ACT_HL2MP_IDLE_PISTOL + 2
		ActivityTranslateFixTF2[ACT_MP_WALK] 							= ACT_HL2MP_IDLE_PISTOL + 1
		ActivityTranslateFixTF2[ACT_MP_CROUCHWALK] 							= ACT_HL2MP_IDLE_PISTOL + 4
		ActivityTranslateFixTF2[ACT_MP_CROUCH_IDLE] 							= ACT_HL2MP_IDLE_PISTOL + 3

		ActivityTranslateFixTF2[ACT_RANGE_ATTACK1] 						= ACT_HL2MP_IDLE_PISTOL + 5
		ActivityTranslateFixTF2[ACT_MP_RELOAD_STAND] 						= ACT_HL2MP_IDLE_PISTOL + 6
		ActivityTranslateFixTF2[ACT_MP_RELOAD_CROUCH] 						= ACT_HL2MP_IDLE_PISTOL + 6
		ActivityTranslateFixTF2[ACT_MP_JUMP] 						= ACT_HL2MP_IDLE_PISTOL + 7
		ActivityTranslateFixTF2[ACT_MP_SWIM_IDLE] 						= ACT_HL2MP_IDLE_PISTOL + 8
		ActivityTranslateFixTF2[ACT_MP_SWIM] 						= ACT_HL2MP_IDLE_PISTOL + 9
		return ActivityTranslateFixTF2[act] or act
	end
end)
hook.Add("EntityEmitSound", "MVMVoices", function(snd)
	...
	if CLIENT and !IsValid(snd.Entity) then return end
	if IsValid(snd.Entity) and snd.Entity:GetModel() and string.find(snd.Entity:GetModel(),"bot_") and !string.find(snd.Entity:GetModel(),"boss") and snd.Entity:GetModelScale() < 1.75 and string.find(snd.SoundName, "step") then
	...
	elseif IsValid(snd.Entity) and snd.Entity:GetModel() and string.StartWith(snd.Entity:GetModel(), "models/player") and !string.find(snd.Entity:GetModel(), "tfc") and snd.Entity:LookupBone("bip_head") and !string.find(snd.Entity:GetModel(), "bot") and string.find(snd.SoundName, "step") then
		...
		if (snd.Entity:WaterLevel() < 1) then
			snd.SoundName = string.Replace(snd.SoundName, "player/footsteps/", "player/footsteps/")
		elseif (snd.Entity:WaterLevel() < 2) then
			snd.SoundName = string.Replace(snd.SoundName, snd.SoundName, "player/footsteps/slosh"..math.random(1,4)..".wav")
		else
			snd.SoundName = string.Replace(snd.SoundName, snd.SoundName, "player/footsteps/wade"..math.random(1,4)..".wav")
		end
