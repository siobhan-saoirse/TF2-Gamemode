...
hook.Remove( "CalcView", "SetPosToRagdoll" )
	...
	if (!ply:Alive()) then
		if (IsValid(ply:GetNWEntity("RagdollEntity"))) then
			if (ply:GetObserverMode() == OBS_MODE_DEATHCAM and ply:GetObserverMode() != OBS_MODE_FREEZECAM) then
				local view = {
					origin = ply:GetNWEntity("RagdollEntity"):GetPos() - ( angles:Forward() * 115 ),
					angles = angles,
					fov = fov,
					drawviewer = true
				}	
...
local LOGFILE = "pf2/log_client.txt"
file.Delete(LOGFILE)
...
hook.Add( "PopulateToolMenu", "Civ2Settings", function()
	spawnmenu.AddToolMenuOption( "Options", "Civilian 2", "Options", "#Civilian 2 Settings", "", "", function( panel )
		panel:ClearControls()
	...
	spawnmenu.AddToolMenuOption( "Options", "Civilian 2", "Customization", "#Customization Settings", "", "", function( panel )
		panel:ClearControls()
...
function GM:OpenMainMenu()
	...
	hl1cooplogo:SetImage("gamemodes/pf2/logo.png")
...
function L4DClassSelection()
	...
	ClassFrame.OnClose = function()
		...
		LocalPlayer():StopSound("music.class_menu") 
	...
	RunConsoleCommand("cl_wpn_sway_interp","0.1")
	...
	TankButton.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "tank")  LocalPlayer():EmitSound("music/safe/themonsterswithout.wav") LocalPlayer():StopSound("ClassSelection.ThemeL4D") ClassFrame:Close()  end
	...
	BoomerButton.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "boomer") ClassFrame:Close() LocalPlayer():EmitSound("music/safe/themonsterswithout.wav") LocalPlayer():StopSound("ClassSelection.ThemeL4D") end
	...
	L4DZombie.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "smoker") ClassFrame:Close() LocalPlayer():EmitSound("music/safe/themonsterswithout.wav") LocalPlayer():StopSound("ClassSelection.ThemeL4D") LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM")end
	...
	Hunter.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "hunter") ClassFrame:Close() LocalPlayer():EmitSound("music/safe/themonsterswithout.wav") LocalPlayer():StopSound("ClassSelection.ThemeL4D") LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
	...
	Charger.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "charger") ClassFrame:Close() LocalPlayer():EmitSound("music/safe/themonsterswithout.wav") LocalPlayer():StopSound("ClassSelection.ThemeL4D") LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
	...
	Jockey.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "jockey") ClassFrame:Close() LocalPlayer():EmitSound("music/safe/themonsterswithout.wav") LocalPlayer():StopSound("ClassSelection.ThemeL4D") LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
	...
	Spitter.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "spitter") ClassFrame:Close() LocalPlayer():EmitSound("music/safe/themonsterswithout.wav") LocalPlayer():StopSound("ClassSelection.ThemeL4D") LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
...
hook.Add( "PlayerSay", "Class Scout", function( ply, text, public )
	...
	if ( string.sub( text, 1 ) == "!changeclass scout" ) then
		RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "scout")
		return false
	end
end )
...
hook.Add( "PlayerSay", "Class Soldier", function( ply, text, public )
	...
	if ( string.sub( text, 1 ) == "!changeclass soldier" ) then
		RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "soldier")
		return false
	end
end )
...
hook.Add( "PlayerSay", "Class Pyro", function( ply, text, public )
	...
	if ( string.sub( text, 1 ) == "!changeclass pyro" ) then
		RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "pyro")
		return false
	end
end )
...
hook.Add( "PlayerSay", "Class Demoman", function( ply, text, public )
	...
	if ( string.sub( text, 1 ) == "!changeclass demoman" ) then
		RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "demoman")
		return false
	end
end )
...
hook.Add( "PlayerSay", "Class Heavy", function( ply, text, public )
	...
	if ( string.sub( text, 1 ) == "!changeclass heavy" ) then
		RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "heavy")
		return false
	end
end )
...
hook.Add( "PlayerSay", "Class Engineer", function( ply, text, public )
	...
	if ( string.sub( text, 1 ) == "!changeclass engineer" ) then
		RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "engineer")
		return false
	end
end )
...
hook.Add( "PlayerSay", "Class Medic", function( ply, text, public )
	...
	if ( string.sub( text, 1 ) == "!changeclass medic" ) then
		RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "medic")
		return false
	end
end )
...
hook.Add( "PlayerSay", "Class Sniper", function( ply, text, public )
	...
	if ( string.sub( text, 1 ) == "!changeclass sniper" ) then
		RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "sniper")
		return false
	end
end )
...
hook.Add( "PlayerSay", "Class Spy", function( ply, text, public )
	...
	if ( string.sub( text, 1 ) == "!changeclass spy" ) then
		RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "spy")
		return false
	end
end )
...
function L4DClassSelection()
	...
	L4DZombie.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "l4d_zombie") ClassFrame:Close() LocalPlayer():EmitSound("music/safe/themonsterswithout.wav") LocalPlayer():StopSound("ClassSelection.ThemeL4D") LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
...
if string.find(game.GetMap(), "mvm_") then
	...
	LocalPlayer():EmitSound("music.class_menu")	
end
...
ScoutButton.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "scout") surface.PlaySound( "/music/class_menu_01.wav" ) ClassFrame:Close()  end
...
SoldierButton.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "soldier") surface.PlaySound( "/music/class_menu_02.wav" ) ClassFrame:Close() if string.find(game.GetMap(), "mvm_") then LocalPlayer():EmitSound("music/mvm_class_select.wav") end LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM")	end
...
PyroButton.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "pyro") surface.PlaySound( "/music/class_menu_03.wav" ) ClassFrame:Close()  if string.find(game.GetMap(), "mvm_") then LocalPlayer():EmitSound("music/mvm_class_select.wav") end LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
...
DemomanButton.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "demoman") surface.PlaySound( "/music/class_menu_04.wav" ) ClassFrame:Close()  if string.find(game.GetMap(), "mvm_") then LocalPlayer():EmitSound("music/mvm_class_select.wav") end LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
...
HeavyButton.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "heavy") surface.PlaySound( "/music/class_menu_05.wav" ) ClassFrame:Close() if string.find(game.GetMap(), "mvm_") then LocalPlayer():EmitSound("music/mvm_class_select.wav") end LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
...
EngineerButton.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "engineer") surface.PlaySound( "/music/class_menu_06.wav" ) ClassFrame:Close() if string.find(game.GetMap(), "mvm_") then LocalPlayer():EmitSound("music/mvm_class_select.wav") end LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
...
MedicButton.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "medic") surface.PlaySound( "/music/class_menu_07.wav" ) ClassFrame:Close() if string.find(game.GetMap(), "mvm_") then LocalPlayer():EmitSound("music/mvm_class_select.wav") end LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
...
SniperButton.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "sniper") surface.PlaySound( "/music/class_menu_08.wav" ) ClassFrame:Close() if string.find(game.GetMap(), "mvm_") then LocalPlayer():EmitSound("music/mvm_class_select.wav") end LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
...
SpyButton.DoClick = function() RunConsoleCommand("cl_wpn_sway_scale","5.0") RunConsoleCommand("changeclass", "spy") surface.PlaySound( "/music/class_menu_09.wav" ) ClassFrame:Close() if string.find(game.GetMap(), "mvm_") then LocalPlayer():EmitSound("music/mvm_class_select.wav") end LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM") end
...
ScoutButton.OnCursorEntered = function() 
	...
	if LocalPlayer():GetPlayerClass() == "scout" then 
		...
		icon2:GetEntity():SetModel("models/weapons/w_models/w_nailgun.mdl") 
	end 
	LocalPlayer():EmitSound( "music.class_menu_01" ) 
	local dance = icon:GetEntity():LookupSequence( "selectionMenu_Anim01" ) 
	icon:GetEntity():SetSequence( dance ) 
	icon:GetEntity():SetModelScale(0.865) 
end
SoldierButton.OnCursorEntered = function() 
	...
	LocalPlayer():EmitSound( "music.class_menu_03" ) 
	local dance = icon:GetEntity():LookupSequence( "selectionMenu_Anim01" ) 
	icon:GetEntity():SetSequence( dance ) 
	icon:GetEntity():SetModelScale(0.865) 
end
PyroButton.OnCursorEntered = function() 
	...
	LocalPlayer():EmitSound( "music.class_menu_07" ) 
	local dance = icon:GetEntity():LookupSequence( "selectionMenu_Anim01" ) 
	icon:GetEntity():SetSequence( dance ) 
	icon:GetEntity():SetModelScale(0.865) 
end
DemomanButton.OnCursorEntered = function() 
	...
	LocalPlayer():EmitSound( "music.class_menu_04" ) 
	local dance = icon:GetEntity():LookupSequence( "selectionMenu_Anim01" ) 
	icon:GetEntity():SetSequence( dance ) 
	icon:GetEntity():SetModelScale(0.865) 
end
HeavyButton.OnCursorEntered = function() 
	...
	LocalPlayer():EmitSound( "music.class_menu_06" ) 
	local dance = icon:GetEntity():LookupSequence( "selectionMenu_Anim01" ) 
	icon:GetEntity():SetSequence( dance ) 
	icon:GetEntity():SetModelScale(0.865) 
end
...
EngineerButton.OnCursorEntered = function() 
	...
	LocalPlayer():EmitSound( "music.class_menu_09" ) 
	local dance = icon:GetEntity():LookupSequence( "selectionMenu_Anim01" ) 
	icon:GetEntity():SetSequence( dance ) 
	icon:GetEntity():SetModelScale(0.865) 
end
...
MedicButton.OnCursorEntered = function() 
	...
	LocalPlayer():EmitSound( "music.class_menu_05" ) 
	local dance = icon:GetEntity():LookupSequence( "selectionMenu_Anim01" ) 
	icon:GetEntity():SetSequence( dance ) 
	icon:GetEntity():SetModelScale(0.865) 
end
...
SniperButton.OnCursorEntered = function() 
	...
	LocalPlayer():EmitSound( "music.class_menu_02" ) 
	local dance = icon:GetEntity():LookupSequence( "selectionMenu_Anim01" ) 
	icon:GetEntity():SetSequence( dance ) 
	icon:GetEntity():SetModelScale(0.865) 
end
SpyButton.OnCursorEntered = function() 
	...
	LocalPlayer():EmitSound( "music.class_menu_08" )  
	local dance = icon:GetEntity():LookupSequence( "selectionMenu_Anim01" ) 
	icon:GetEntity():SetSequence( dance ) 
	icon:GetEntity():SetModelScale(0.865) 
end
...
if (!GetConVar("tf_disable_fun_classes"):GetBool()) then
	...
	GmodButton.DoClick = function() RunConsoleCommand("changeclass", "gmodplayer") RunConsoleCommand("cl_wpn_sway_interp","0.1") RunConsoleCommand("cl_wpn_sway_scale","1.0") ClassFrame:Close() if string.find(game.GetMap(), "mvm_") then LocalPlayer():EmitSound("music/mvm_class_select.wav") end LocalPlayer():StopSound("music.class_menu") LocalPlayer():StopSound("ClassSelection.ThemeMVM")  end
