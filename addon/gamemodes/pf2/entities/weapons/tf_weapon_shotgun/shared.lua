...
SWEP.ShootSound = Sound("TF_Weapon_Shotgun.Single")
SWEP.ShootCritSound = Sound("TF_Weapon_Shotgun.SingleCrit")
SWEP.ReloadSound = Sound("TF_Weapon_Shotgun.WorldReload")
