...
SWEP.ShootSound = Sound("TF_Weapon_Pistol.Single")
SWEP.ShootCritSound = Sound("TF_Weapon_Pistol.SingleCrit")
SWEP.ReloadSound = Sound("TF_Weapon_Pistol.WorldReloadEngineer")
