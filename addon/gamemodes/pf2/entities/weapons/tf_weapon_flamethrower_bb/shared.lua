...
SWEP.ShootSound = Sound("Weapon_BackBurner.FireStart")	
SWEP.SpecialSound1 = Sound("Weapon_BackBurner.FireLoop") 
SWEP.ShootCritSound = Sound("Weapon_BackBurner.FireCritLoop")
SWEP.ShootSoundEnd = Sound("Weapon_BackBurner.FireEnd")
