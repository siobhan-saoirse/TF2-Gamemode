...
function SWEP:SetupBuilding(obj)
	if self.Owner:GetPlayerClass() != "spy" and obj.v_model and obj.w_model then
...
function SWEP:Holster()
	...
	if IsValid(self.Owner) and self.Owner:GetPlayerClass() == "spy" and self:GetItemData().model_player == "models/weapons/c_models/c_p2rec/c_p2rec.mdl" then
