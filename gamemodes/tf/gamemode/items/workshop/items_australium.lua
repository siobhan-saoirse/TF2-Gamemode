"items_game"
{
	...
	"items"
	{
		...
		"10000036"
		{
			...
			"min_ilevel"	"1"
			"max_ilevel"	"1"
			"image_inventory"	"backpack/weapons/w_models/w_medigun_gold"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
		...
		"10000038"
		{
			...
			"min_ilevel"	"1"
			"max_ilevel"	"1"
			"image_inventory"	"backpack/weapons/w_models/w_scattergun_gold"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
		...
		"10000057"
		{
			"name"	"Australium Black Box"
			"item_class"	"tf_weapon_rocketlauncher_bbox"
			"craft_class"	"weapon"
			"item_name"	"Australium Black Box"
			...
			"min_ilevel"	"1"
			"max_ilevel"	"1"
			"image_inventory"	"backpack/workshop/weapons/c_models/c_blackbox/c_blackbox_gold_large"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			...
			"attributes"
			{
				...
				{
					"attribute_class"	"material_override"
					"value"		"models/workshop/weapons/c_models/c_blackbox/c_blackbox_gold"
				}
		...
		"10000534"
		{
			...
			"show_in_armory"	"1"
			"item_type_name"	"#TF_Weapon_Minigun"
			"item_name"	"Goal Keeper"
			"item_slot"	"primary"
			"item_logname"	"goal_keeper"
			"item_iconname"	"natascha"
			"image_inventory"	"backpack/weapons/c_models/c_w_ludmila/c_w_ludmila"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_goalkeeper/c_goalkeeper.mdl"
			"attach_to_hands"	"1"
			"item_quality"	"unique"
			"min_ilevel"	"5"
			"max_ilevel"	"5"
		...
		"10000535"
		{
			...
			"item_name"	"Big Mean Mother Hubbard"
			"item_slot"	"primary"
			"item_logname"	"big_mean"
			"item_iconname"	"shotgun"
			"image_inventory"	"backpack/weapons/w_models/w_shotgun"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_big_mean_mother_hubbard/c_big_mean.mdl"
			"attach_to_hands"	"1"
			"item_quality"	"unique"
			"min_ilevel"	"5"
			"max_ilevel"	"5"
		...
		"10000536"
		{
			...
			"item_name"	"Big Tex"
			"item_slot"	"secondary"
			"item_logname"	"big_tex"
			"item_iconname"	"revolver"
			"image_inventory"	"backpack/weapons/w_models/w_revolver"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_big_tex/c_big_tex.mdl"
			"attach_to_hands"	"1"
			"item_quality"	"unique"
			"min_ilevel"	"5"
			"max_ilevel"	"5"
		...
		"10000538"
		{
			...
			"item_name"	"Headtrimmer"
			"item_slot"	"melee"
			"item_logname"	"headtrimmer"
			"item_iconname"	"shovel"
			"image_inventory"	"backpack/weapons/w_models/w_bottle"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_headtrimmer/c_headtrimmer.mdl"
			"attach_to_hands"	"1"
			"item_quality"	"unique"
			"min_ilevel"	"5"
			"max_ilevel"	"5"
		...
		"10000539"
		{
			...
			"show_in_armory"	"1"
			"item_type_name"	"#TF_Weapon_Shovel"
			"item_name"	"Maggot Masher"
			"item_slot"	"melee"
			"item_logname"	"maggot_masher"
			"item_iconname"	"shovel"
			"image_inventory"	"backpack/weapons/w_models/w_shovel"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_maggot_masher/c_maggot_masher.mdl"
			"attach_to_hands"	"1"
			"item_quality"	"unique"
			"min_ilevel"	"5"
			"max_ilevel"	"5"
		...
		"10000540"
		{
			...
			"show_in_armory"	"1"
			"item_type_name"	"#TF_Weapon_Flamethrower"
			"item_name"	"Griefblower"
			"item_slot"	"primary"
			"item_logname"	"griefblower"
			"item_iconname"	"natascha"
			"image_inventory"	"backpack/weapons/w_models/w_flamethrower"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_griefblower/c_griefblower.mdl"
			"attach_to_hands"	"1"
			"item_quality"	"unique"
			"min_ilevel"	"5"
			"max_ilevel"	"5"
		...
		"10000541"
		{
			...
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_schwaben_charger/c_schwaben_charger.mdl"
			"attach_to_hands"	"1"
			"item_quality"	"unique"
			"min_ilevel"	"5"
			"max_ilevel"	"5"
		...
		"10000542"
		{
			...
			"show_in_armory"	"1"
			"item_type_name"	"#tf_weapon_syringegun_medic"
			"item_name"	"The Other Overdose"
			"item_slot"	"primary"
			"item_logname"	"other_overdose"
			"image_inventory"	"backpack/weapons/w_models/w_syringegun"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_overdose/c_overdose.mdl"
			"attach_to_hands"	"1"
			"item_quality"	"unique"
			"min_ilevel"	"5"
			"max_ilevel"	"5"
		...
		"10000543"
		{
			...
			"show_in_armory"	"1"
			"item_type_name"	"#TF_Weapon_Shotgun"
			"item_name"	"Surv Slugger"
			"item_slot"	"secondary"
			"item_logname"	"surv_slugger"
			"item_iconname"	"shotgun"
			"image_inventory"	"backpack/weapons/w_models/w_shotgun"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_survivalist_slugger/c_surv_slugger.mdl"
			"attach_to_hands"	"1"
			"item_quality"	"unique"
			"min_ilevel"	"5"
			"max_ilevel"	"5"
		...
		"10000545"
		{
			...
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_the_big_bang/c_the_big_bang.mdl"
			"attach_to_hands"	"1"
			"used_by_classes"
			{
				"demoman"	"1"
		...
		"10000546"
		{
			...
			"craft_class"	"weapon"
			"item_type_name"	"Not Medicine"
			"item_name"	"Tonsil Clamp"
			"item_slot"	"melee"
			"item_quality"	"normal"
			"baseitem" "1"
			"min_ilevel"	"1"
			...
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_tonsil_clamp/c_tonsil_clamp.mdl"
			"attach_to_hands"	"1"
			"used_by_classes"
			{
				"medic"	"1"
		...
		"10000547"
		{
			...
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/weapons/c_models/c_targe/c_targe_user.mdl"
			"attach_to_hands"	"1"
			"used_by_classes"
			{
				"demoman"	"1"
